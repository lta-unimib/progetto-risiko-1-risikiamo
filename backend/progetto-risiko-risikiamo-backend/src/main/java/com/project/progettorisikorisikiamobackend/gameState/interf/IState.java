...
public interface IState extends IPlayer {
    ...
    public default void endTurn() {
        throw new UnsupportedOperationException("Can't end turn in at this moment");
    }

    public default void redeemReinforcementsCard(CardTerritory c1, CardTerritory c2, CardTerritory c3) {
        throw new UnsupportedOperationException("Can't redeem reinforcements card in at this moment");
    }

    @Override
    public default void placeReinforcements(Territory ownTerritory, int armies) {
        throw new UnsupportedOperationException("Can't place reinforcements in at this moment");
    }
